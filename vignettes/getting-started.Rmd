...
For more information on retrieving data and metadata from the [`ev_data`](https://borninbradford.github.io/epivaultr/articles/features-concepts.html#ev_data---the-data-extract) container, see the [Reference](https://borninbradford.github.io/epivaultr/reference/index.html#get-data-from-containers) section.
